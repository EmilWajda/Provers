...
const CreateWorkspace = ({ onCreate }: CreateWorkspaceProps) => {
  ...
  return (
    <div className="p-4">
      <form onSubmit={handleSubmit} className="flex flex-col gap-2 bg-white p-3 rounded-lg border border-gray-300 shadow-sm">
        <input 
          autoFocus
          type="text" 
